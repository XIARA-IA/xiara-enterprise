...
## V5.5.1 FIRMA CORE CLEAN PATCH L
- Recuperado desde V5.5.0 HOTFIX C limpio.
- Parche inline, sin dependencia de archivo externo, para evitar cache/404.
- Panel Firma y sello oficial XIARA V5.5.1 CLEAN L.
- Corrige visualización de firma personal en panel y conserva sello empresa.
- Añade diagnóstico xiaraFirmaDiagnosticoL().
