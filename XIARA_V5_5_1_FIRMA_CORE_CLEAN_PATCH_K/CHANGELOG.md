...
## V5.5.1 FIRMA CORE CLEAN PATCH K
- Base recuperada: V5.5.0 STORAGE ENTERPRISE HOTFIX C.
- Se descartan HOTFIX D-J contaminados.
- Se añade js/xiara-firma-core-clean.js como panel limpio independiente de firma/sello.
- Guarda firma personal y sello oficial en estructura compatible con PRL/EPI/RRHH.
- Añade diagnóstico xiaraFirmaDiagnosticoK().
- No modifica diseño global ni módulos existentes.
