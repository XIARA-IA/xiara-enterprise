...
## V5.5.2 PRL/EPI SAFE OPEN + LAYOUT PATCH S
- Base estable PATCH N.
- Corrige apertura PRL/EPI con visor seguro sin depender de h() ni modal().
- Reinstala xiaraOpenPRLSaved al final para que el código viejo no lo pise.
- Separa firma empresa y sello empresa para evitar superposición.
