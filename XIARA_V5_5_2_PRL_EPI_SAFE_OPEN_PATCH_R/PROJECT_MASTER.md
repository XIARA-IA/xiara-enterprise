# XIARA V5.5.2 PRL/EPI SAFE OPEN PATCH R

- Base: PATCH N estable.
- Corrige apertura de documentos PRL/EPI guardados sin depender de h() ni modal().
- Reinstala xiaraOpenPRLSaved periódicamente para evitar que código antiguo lo pise.
- Mantiene sello/firma empresa persistentes del PATCH N.
