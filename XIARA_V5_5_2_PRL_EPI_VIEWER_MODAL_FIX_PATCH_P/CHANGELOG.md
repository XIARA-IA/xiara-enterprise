...
## V5.5.2 PRL/EPI VIEWER + FIRMA/SELLO LAYOUT PATCH O
- Corrige `h is not defined` al abrir documentos PRL/EPI guardados desde ficha de empleado.
- Separa firma empresa y sello empresa en el documento EPI para evitar superposición.
- Normaliza el HTML PRL/EPI al previsualizar, guardar y abrir documentos guardados.
- Mantiene el sistema de persistencia de sello/firma empresa del PATCH N.


## V5.5.2 PATCH P
- Corrige TypeError: modal is not a function en xiaraOpenPRLSaved.
- Mantiene firma empresa y sello empresa separados en PRL/EPI.
- Añade xiaraModalSafeP() y xiaraPRLDiagnosticoP().
